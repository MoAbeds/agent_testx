...
function SerpsContent() {
  ...
  const handleSearch = async (e?: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/seo/serp', {
        ...
        body: JSON.stringify({ siteId: site.id, keyword: keyword.trim() })
      });
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
        ...
        <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              placeholder="Enter target keyword (e.g., 'best seo agent 2026')"
          ...
          <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0a0a0a] border border-gray-800 rounded-2xl p-6">
              <div className="flex items-center gap-4 mb-4 text-blue-400">
                ...
                <span className="text-xs font-black uppercase tracking-widest text-gray-400">Search Landscape</span>
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-[#0a0a0a] border border-gray-800 rounded-2xl overflow-hidden shadow-sm">
              <div className="p-4 border-b border-gray-800 bg-gray-900/30 flex justify-between items-center">
                ...
                <span className="text-[10px] font-mono text-gray-500">{keyword}</span>
              </div>
      ...
      {results.length === 0 && !loading && !initialLoading && (
        <div className="p-20 border border-dashed border-gray-800 rounded-2xl bg-gray-900/10 text-center flex flex-col items-center">
          ...
          <p className="text-gray-600 mt-2 max-w-sm">Enter a keyword above to see how you stack up against the competition on Google's first page.</p>
        </div>
      )}
    </div>
  );
