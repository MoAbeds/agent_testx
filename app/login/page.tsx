    ...
    <>
      {isVerify ? (
        <div className="text-center py-4 animate-in fade-in zoom-in duration-300">
          <div className="w-16 h-16 bg-terminal/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <Mail className="text-terminal" size={32} />
          </div>
          ...
          <button 
            ...
            className="text-terminal hover:underline text-sm font-medium"
          >
            Back to login
          </button>
        </div>
        ...
        <>
          ...
          <div className="mt-6 pt-6 border-t border-gray-800 text-center">
            <p className="text-sm text-gray-400">
              ...
              <Link href="/signup" className="text-terminal hover:underline font-medium">
                Start free trial
              </Link>
            </p>
          </div>
        ...
        <div className="relative bg-gray-900/60 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-8 shadow-2xl">
          <Suspense fallback={
            <div className="flex items-center justify-center p-12">
              <Loader2 className="animate-spin text-terminal" size={32} />
            </div>
          }>
            <LoginContent />
          </Suspense>
